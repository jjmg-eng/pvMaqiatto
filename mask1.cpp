////////////////////////////////////////////////////////////////////////////
//
// show_mask1 for ProcessViewServer created: sáb out 10 19:51:57 2020
//
////////////////////////////////////////////////////////////////////////////
#include "pvapp.h"
...
static int generated_defineMask(PARAM *p)
{
  ...
  pvQLabel(p,obj1,0);
  pvSetGeometry(p,obj1,1,1,306,69);
  pvSetFont(p,obj1,"Ubuntu",11,0,0,0,0);

  pvQPushButton(p,obj2,0);
  pvSetGeometry(p,obj2,24,75,99,30);
  pvSetText(p,obj2,pvtr("PushButton"));
